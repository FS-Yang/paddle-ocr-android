...
Java_com_fsyang_paddleocr_OCRPredictorNative_init(
...
Java_com_fsyang_paddleocr_OCRPredictorNative_forward(
...
Java_com_fsyang_paddleocr_OCRPredictorNative_release(
